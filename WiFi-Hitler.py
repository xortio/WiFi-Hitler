...
print('The user you have loggined as is '+v)
print('The local ip address of this system is '+a)
def wifi_details():
...
PRESS 2 to lanscan this device 

PRESS 3 to see the mac address of this device 

PRESS 4 to see the network mapping of this device

PRESS 5 to stop-computer
O==(ZZZZZZZ> '''))
if q=='1':
   wifi_details()
   o=str(input("PRESS ENTER "))
elif q=='2':
   lanscan()
   t=str(input("PRESS ENTER "))
elif q=='3':
   macaddress()
   m=str(input("PRESS ENTER "))
elif q=='4':
   nmap()
   e=str(input("PRESS ENTER "))
elif q=='5':
   stop()
   h=str(input("PRESS ENTER "))
else:
   print('there was a error')
   w=str(input("PRESS AMY KEY TO EXIT"))